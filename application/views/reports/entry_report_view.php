<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Department Wise Entries</li>
		</ul><!-- /.breadcrumb -->
								...
								<table class="table table-striped table-bordered table-hover" id="myTable">
									<thead class="thin-border-bottom">
										<tr>
											...
											<td style="vertical-align:middle;text-align:center;">ટોટલ એન્ટ્રી</td>
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $data[$key]['total_entry'];?></td>
