				...
				<div class="col-sm-12">
					<div class="widget-box widget-color-blue ui-sortable-handle">
						<div class="widget-header">
							...
							<a class="pull-right btn btn-warning btn-large" href="<?php echo site_url('reports/export?name=all_cases_report');?>">
								...
								<table class="table table-striped table-bordered table-hover" id="myTable">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $data[$key]['case_type'];?></td>
